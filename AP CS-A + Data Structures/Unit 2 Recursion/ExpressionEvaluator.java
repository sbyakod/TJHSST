...
/**
This program calculates the finvalue of an expression 
...
////////////////////////////////////////////////////////////
//Name: Sharath Byakod   Period: 6   Date: 10/16/16
...
/**
   ...
   @return the finvalue of the expression.
*/
   public int getExpressionValue()
   {
      int finval = getTermValue();
      int tempval = 0;
      ...
      while(checker == false)
      {
         String s = tokenizer.peekToken();
         if(("-").equals(s) || ("+").equals(s))
         {
            tokenizer.nextToken();
            tempval = getTermValue();
            if("-".equals(s))
            {
...
/**
   ...
   @return the finvalue of the term
*/
   public int getTermValue()
   {
      int tempval = 0;
      int finval = getFactorValue();
...
/**
   ...
   @return the finvalue of the factor
*/
